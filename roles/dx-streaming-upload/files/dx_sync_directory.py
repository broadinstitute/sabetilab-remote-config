        ...
        if log['tar_files'][tar_file]['status'] == 'tarred':
            ...
            if args.dxpy_upload:
                ...
                if args.verbose:
                    ...
                    verbose_flag = ''
                ua_command = "ua --project %s --folder %s --do-not-compress --wait-on-close --progress %s %s --chunk-size 25M -u 1 -v" % (tar_destination_project, tar_destination_folder, verbose_flag, tar_file)
